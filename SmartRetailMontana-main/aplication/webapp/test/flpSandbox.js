		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Retail",
									"targetURL": "#srmaplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"srmaplication-display": {
								"semanticObject": "srmaplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=srm.aplication",
									"url": sap.ui.require.toUrl("srm/aplication")
								}
							}
						}
					}
