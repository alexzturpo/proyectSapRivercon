		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "SMARTPACKING",
									"targetURL": "#spsmartpacking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"spsmartpacking-display": {
								"semanticObject": "spsmartpacking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sp.smartpacking",
									"url": sap.ui.require.toUrl("sp/smartpacking")
								}
							}
						}
					}
