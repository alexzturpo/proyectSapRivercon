		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Agri",
									"targetURL": "#smui5smartagri-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smui5smartagri-display": {
								"semanticObject": "smui5smartagri",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sm.ui5smartagri",
									"url": sap.ui.require.toUrl("sm/ui5smartagri")
								}
							}
						}
					}
