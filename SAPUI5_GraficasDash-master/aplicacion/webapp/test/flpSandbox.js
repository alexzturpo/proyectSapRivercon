		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#gdaplicacion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gdaplicacion-display": {
								"semanticObject": "gdaplicacion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gd.aplicacion",
									"url": sap.ui.require.toUrl("gd/aplicacion")
								}
							}
						}
					}
