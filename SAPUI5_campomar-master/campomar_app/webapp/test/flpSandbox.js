		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App campomar",
									"targetURL": "#appccampomarapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appccampomarapp-display": {
								"semanticObject": "appccampomarapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appc.campomarapp",
									"url": sap.ui.require.toUrl("appc/campomarapp")
								}
							}
						}
					}
