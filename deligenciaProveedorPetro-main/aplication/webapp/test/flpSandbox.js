		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicativo para Diligencia de Proveedore",
									"targetURL": "#adpaplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"adpaplication-display": {
								"semanticObject": "adpaplication",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=adp.aplication",
									"url": sap.ui.require.toUrl("adp/aplication")
								}
							}
						}
					}
