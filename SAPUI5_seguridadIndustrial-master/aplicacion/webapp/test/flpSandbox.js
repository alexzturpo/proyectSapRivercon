		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#afsaplicacion-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"afsaplicacion-display": {
								"semanticObject": "afsaplicacion",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=afs.aplicacion",
									"url": sap.ui.require.toUrl("afs/aplicacion")
								}
							}
						}
					}
