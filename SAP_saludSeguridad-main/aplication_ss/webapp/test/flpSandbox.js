		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Salud y Seguridad",
									"targetURL": "#appssaplicationss-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appssaplicationss-display": {
								"semanticObject": "appssaplicationss",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appss.aplicationss",
									"url": sap.ui.require.toUrl("appss/aplicationss")
								}
							}
						}
					}
