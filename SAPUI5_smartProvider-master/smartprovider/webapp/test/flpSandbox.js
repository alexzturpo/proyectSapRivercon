		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Provider",
									"targetURL": "#appspsmartprovider-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appspsmartprovider-display": {
								"semanticObject": "appspsmartprovider",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appsp.smartprovider",
									"url": sap.ui.require.toUrl("appsp/smartprovider")
								}
							}
						}
					}
